...
- La aplicación no contiene publicidad, analíticas ni servicios de terceros.
- La aplicación no solicita permisos especiales del sistema (ubicación, cámara, micrófono, contactos, etc.).

## 3. Permisos utilizados

La aplicación usa el sintetizador de texto a voz (TTS) del sistema Android, que es una funcionalidad del propio dispositivo. No se envía audio ni texto a servidores externos.
...
Si se realizan cambios significativos en esta política de privacidad, se publicará la versión actualizada en esta misma URL con la nueva fecha de actualización.

## 7. Contacto

Si tienes preguntas sobre esta política de privacidad, puedes contactar con el desarrollador en:

**Correo electrónico:** andymartin1991@gmail.com
